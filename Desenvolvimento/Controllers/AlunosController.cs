...
namespace Desenvolvimento.Controllers
{
    public class AlunosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Email,DataCadastro,Ativo")] Alunos alunos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Email,DataCadastro,Ativo")] Alunos alunos)
        {
            if (id != alunos.Id)
            {
                return NotFound();
